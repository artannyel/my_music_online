...
## 4. Divisão de Tasks
- [ ] [Task 1: Core - Menu de Contexto Global (Long Press)](./task-1-global-context-menu.md)
- [ ] [Task 2: Playlist & Album - Gerenciamento Avançado](./task-2-advanced-playlist-management.md)
- [ ] [Task 3: UI/UX - Reordenação e Swipe to Delete nas Listas](./task-3-drag-drop-and-swipe.md)
- [ ] [Task 4: Player - Persistência, Fila e Integrações](./task-4-player-queue-and-persistence.md)
