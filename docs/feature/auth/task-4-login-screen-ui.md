# Task 4: Presentation - Interface de Login (LoginScreen)

## 📌 Descrição Aprofundada
Desenvolver a interface gráfica de login com visual escuro elegante baseado nas diretrizes do Stitch.
...
## ✅ Critérios de Aceite
- UI moderna e clean alinhada ao protótipo do Stitch.
