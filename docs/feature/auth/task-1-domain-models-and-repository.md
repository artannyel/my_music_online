...
2. Criar `lib/src/features/auth/domain/repositories/auth_repository.dart`:
   - Assinaturas de métodos: `signInWithEmailAndPassword`, `signUpWithEmailAndPassword`, `signInWithGoogle`, `signOut`, `get currentUser`, `Stream<UserModel?> get authStateChanges`.
