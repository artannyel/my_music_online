...
class PlayerStateModel {
  ...
  PlayerStateModel copyWith({
    ...
    return PlayerStateModel(
      ...
      mixUrl: clearMix ? null : (mixUrl ?? this.mixUrl),
      mixNextPageToken: clearMix ? null : (mixNextPageToken ?? this.mixNextPageToken),
